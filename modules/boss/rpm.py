...
def parse_spec(spec_file, keep_config=False, macros=None):
    ...
    :param macros: Macros to add in the rpm env before parsing the spec file.
        Dictionary with macro name => value
