...
class TestParticipantHandler(BaseTestParticipantHandler):
    ...
    def test_handle_wi(self):
        ...
        # If so, return True
        wid.fields.delete = True
        self.participant.obs.toggleProjectAttribute.return_value = True
        self.participant.handle_wi(wid)
        self.assertTrue(wid.fields.needs_build)

        # Test: Project attribute deleted -> False
        # If so, return False
        self.participant.obs.toggleProjectAttribute.return_value = False
        self.participant.handle_wi(wid)
        self.assertFalse(wid.fields.needs_build)
